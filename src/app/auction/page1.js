...
export default function Auction() {
  ...
  useEffect(() => {
    ...
    socket.on("timer_update", (timeLeft) => {
      setTimer(timeLeft);
      if (timeLeft === 0 && !currentBid.team && player) {
        ...
        setPlayer(null); // Reset player after going unsold
      }
    });
    ...
    socket.on("player_sold", ({ player, team_id, price }) => {
      ...
      toast.success(
        `${player.name} sold to ${getTeamName(team_id)} for ₹${price}L!`,
        {
          duration: 3000,
          position: "top-right",
          style: {
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                ...
                <div className="bg-white/90 backdrop-blur-md p-2 rounded-xl shadow-md text-center">
                  ...
                  <p className="text-lg font-bold">₹{currentBid.amount}L</p>
                </div>
                <div className="bg-white/90 backdrop-blur-md p-2 rounded-xl shadow-md text-center">
                  <p className="text-sm font-semibold">Team</p>
                  <p className="text-lg font-bold truncate">
                    {getTeamName(currentBid.team)}
                  </p>
                </div>
              </div>
              ...
              {/* Current Team */}
              <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-md p-4 mb-20">
                ...
                {currentTeam && currentTeamStats ? (
                  ...
                  <div className="text-center py-2">
                    <p className="text-gray-500 mb-2">No team selected</p>
                    <button
            ...
            <div className="mb-20">
              ...
              <section className="bg-white/90 backdrop-blur-md rounded-xl shadow-md p-4 mb-4">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-lg font-semibold">Players Sold</h2>
                  <select
                    className="border border-gray-300 rounded-lg px-2 py-1 text-sm"
                    value={selectedFilterTeam || ""}
                    onChange={(e) =>
                      setSelectedFilterTeam(e.target.value || null)
                    }
                  >
                ...
                <div className="space-y-3 max-h-[30vh] overflow-y-scroll">
                  {loading ? (
                    ...
                    filteredPlayersBought.map((player) => (
                      <div
                        ...
                        className="border p-2 rounded-lg bg-white/80"
                      >
              ...
              <section className="bg-white/90 backdrop-blur-md rounded-xl shadow-md p-4">
                <h2 className="text-lg font-semibold mb-3">Top Buys</h2>
                <div className="space-y-3 max-h-[30vh] overflow-y-scroll">
                  {loading ? (
                    <p className="text-center text-gray-500">
                      Loading top buys...
  ...
  return (
    <div
      className="min-h-screen w-full flex flex-col p-3 sm:p-6 bg-cover bg-center relative"
      style={{
